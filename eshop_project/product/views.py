...
class ProductDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['related_products'] = group_list(list(Product.objects.filter(brand_id=loaded_product.brand_id).exclude(pk=loaded_product.id).all()[:8]), 3)
...
def product_brands_component(request: HttpRequest):
    ...
    return render(request, 'product/components/product_brand_component.html', context)
